...
var (
	...
	right = [...]string{
		...
		// Evan Prodromou is the director of Open Technology at Open Earth Foundation, and one of the members of the ActivityPub WICG
		"prodromou",
		...
		// Christine Lemmer Webber - responsible for a big part of the ActivityPub spec
		"webber",
